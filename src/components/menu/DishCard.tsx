  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col md:flex-row">
        ...
        {/* Image */}
        <div
          className="relative overflow-hidden flex-shrink-0 md:w-[130px] md:h-[98px]"
        ...
        >
          ...
          <div
            className="absolute bottom-0 left-0 right-0 h-10 pointer-events-none md:hidden"
            style={{ background: "linear-gradient(to bottom, transparent, rgba(26,25,22,0.45))" }}
          />
        </div>

        {/* Content */}
        <div className="p-3 md:flex-1 md:flex md:flex-col md:justify-between">
          <div>
            <h3
